...
- **Node.js** (default): Available on `linux/amd64`, `linux/arm64`, and `linux/arm/v7`. Use standard tags like `latest`, `v0.45.2`.
- **Bun**: Faster alternative available on `linux/amd64` and `linux/arm64` only. Use tags with `bun` suffix (e.g., `bun`, `v0.45.2-bun`).
...
*   [`v0.45.2`](https://hub.docker.com/r/tgagor/gemini-cli/tags): Specific version.
*   [`v0.45.2-alpine`](https://hub.docker.com/r/tgagor/gemini-cli/tags): Specific version with Alpine base.
...
*   [`v0.45.2-bun`](https://hub.docker.com/r/tgagor/gemini-cli/tags): Specific version with Bun.
