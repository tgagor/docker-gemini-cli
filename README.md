...
- **Node.js** (default): Available on `linux/amd64`, `linux/arm64`, and `linux/arm/v7`. Use standard tags like `latest`, `v0.52.0`.
- **Bun**: Faster alternative available on `linux/amd64` and `linux/arm64` only. Use tags with `bun` suffix (e.g., `bun`, `v0.52.0-bun`).
...
*   [`v0.52.0`](https://hub.docker.com/r/tgagor/gemini-cli/tags): Specific version.
*   [`v0.52.0-alpine`](https://hub.docker.com/r/tgagor/gemini-cli/tags): Specific version with Alpine base.
*   [`v0.52`](https://hub.docker.com/r/tgagor/gemini-cli/tags): Latest patch for a minor version.
*   [`v0.52-alpine`](https://hub.docker.com/r/tgagor/gemini-cli/tags): Latest patch with Alpine base.
...
*   [`v0.52.0-bun`](https://hub.docker.com/r/tgagor/gemini-cli/tags): Specific version with Bun.
*   [`v0.52-bun`](https://hub.docker.com/r/tgagor/gemini-cli/tags): Latest patch for a minor version with Bun.
